          ...
          <tbody>
            ...
            {showDisableFields && (
              <>
                <tr>
                  ...
                  <td>
                    <input id="is-disabled" name="is_disabled" type="checkbox" />
                  </td>
                </tr>
                <tr>
                  <td>
                    <label htmlFor="disabled-reason">Disable comments</label>
                  </td>
                  <td>
                    <textarea id="disabled-reason" name="disabled_reason" rows={5} />
                  </td>
                </tr>
              </>
            )}
            <tr>
              ...
              <td>
                ...
                {onRenew && (
                  <button type="button" onClick={onRenew}>Renew</button>
                )}
              </td>
            </tr>
          </tbody>
